...
public static boolean isUpperCase(String s)
{
    ...
    public static void main(String[] args) throws Exception {
           ...
           Document catalog = Jsoup.connect("https://my.sa.ucsb.edu/Public/curriculum/coursesearch.aspx").get();
           ...
           while(newparsing.hasNext()){//While there exists something still in the section of the page unread
